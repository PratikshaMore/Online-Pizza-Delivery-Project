...
if ($action == 'student_welcome' || $action == 'select_room') {
    ...
    if($n > $flourQty || $n > $cheeseQty){
        $e = "Insuffficient stock in inventory for ".$n." pizzas (cheese :".$cheeseQty.", flour :".$flourQty.")";
        include('../errors/error.php');
        exit();  
    } else {
        //reduce inventory by n
        set_inventory_values($db, $flourQty-$n, $cheeseQty-$n);
    }
    
//     if($n > 50){
//        $e = "Cannot place a order in a single day for more than ".$n." pizzas";
//        include('../errors/error.php');
//        exit();  
//    } else {
//        //reduce inventory by n
